...
import { Menu, X, Car, Bell, MessageSquare, ChevronDown, Settings, LogOut, Lock } from 'lucide-react';
      ...
      <nav className="container mx-auto px-4">
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 space-y-4 pb-4">
            <a href="#services" className="block text-gray-600 hover:text-emerald-600">Services</a>
            <a href="#safety" className="block text-gray-600 hover:text-emerald-600">Sécurité</a>
            <a href="#drivers" className="block text-gray-600 hover:text-emerald-600">Chauffeurs</a>
            <Link to="/messages" className="block text-gray-600 hover:text-emerald-600">Messages</Link>
            <Link to="/notifications" className="block text-gray-600 hover:text-emerald-600">Notifications</Link>
            <Link to="/profile" className="block text-gray-600 hover:text-emerald-600">Mon profil</Link>
            <button
