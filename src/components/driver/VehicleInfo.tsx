    ...
    <>
      <div className="bg-white rounded-xl shadow-md p-6">
        ...
        {vehicleData?.model ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">{vehicleData.type}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold">{vehicleData.plateNumber}</div>
          ...
          <div className="text-center text-gray-500">Aucune voiture enregistrée.</div>
        )}
      </div>
