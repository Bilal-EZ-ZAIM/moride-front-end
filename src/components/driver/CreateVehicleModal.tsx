...
export function CreateVehicleModal({
  ...
  const validateForm = () => {
    ...
    if (!formData.license)
      newErrors.license = "La plaque d'immatriculation est requise";
    if (!formData.insurance)
      newErrors.insurance = "La date d'assurance est requise";
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              ...
              />
              {errors.insurance && (
                <p className="text-red-500 text-sm">{errors.insurance}</p>
              )}
            </div>
              ...
              {!imagePreview ? (
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Sélectionnez une photo pour le véhicule
                  </p>
