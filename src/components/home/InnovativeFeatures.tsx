  ...
  const features = [
    {
      icon: Sparkles,
      title: "IA Prédictive",
      description: "Optimisation intelligente des trajets et prévision de la demande"
    },
    {
      icon: Shield,
    ...
    <section className="py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Innovation & Technologie</h2>
          <p className="text-xl text-gray-600">Des solutions modernes pour vos déplacements</p>
        </div>
